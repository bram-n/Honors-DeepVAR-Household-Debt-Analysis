...
def create_model_comparison_latex_table(lstm_metrics, var_metrics, pvar_metrics):
...
\end{{tabular}}
\end{{table}}""".format(
        lstm_metrics[0], var_metrics[0],  pvar_metrics[0],
        lstm_metrics[1], var_metrics[1], pvar_metrics[1],
        lstm_metrics[2], var_metrics[2], pvar_metrics[2]
    )
